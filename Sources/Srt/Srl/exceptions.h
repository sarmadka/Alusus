...
#ifndef SRL_EXCEPTIONS_H
#define SRL_EXCEPTIONS_H
...
#define DEFINE_EXCEPTION(exceptionName, base, title) \
  ...
  public: \
    ...
    virtual Srl::String getErrorMessage() const throw() \
    { \
      return Srl::String(S(title)) + S(": ") + this->getComment(); \
    } \
  }
