/**
 * @file Core/Grammar/SequenceCharGroupUnit.h
 * Contains the header of class Core::Grammar::SequenceCharGroupUnit.
 *
...
#ifndef CORE_GRAMMAR_SEQUENCECHARGROUPUNIT_H
#define CORE_GRAMMAR_SEQUENCECHARGROUPUNIT_H
...
class SequenceCharGroupUnit : public CharGroupUnit
{
  ...
  TYPE_INFO(SequenceCharGroupUnit, CharGroupUnit, "Core.Grammar", "Core", "alusus.org");
