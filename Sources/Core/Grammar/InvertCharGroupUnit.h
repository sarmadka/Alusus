/**
 * @file Core/Grammar/InvertCharGroupUnit.h
 * Contains the header of class Core::Grammar::InvertCharGroupUnit.
 *
...
#ifndef CORE_GRAMMAR_INVERTCHARGROUPUNIT_H
#define CORE_GRAMMAR_INVERTCHARGROUPUNIT_H
...
class InvertCharGroupUnit : public CharGroupUnit
{
  ...
  TYPE_INFO(InvertCharGroupUnit, CharGroupUnit, "Core.Grammar", "Core", "alusus.org");
