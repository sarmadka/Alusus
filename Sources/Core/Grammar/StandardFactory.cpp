/**
 * @file Core/Grammar/StandardFactory.cpp
 * Contains the implementation of class Core::Grammar::StandardFactory.
 *
...
void StandardFactory::createGrammar(
  Module *grammarRoot, Main::RootManager *root, Bool exprOnly
) {
  this->setRoot(grammarRoot);
  ...
  this->scopeParsingHandler = newSrdObj<ScopeParsingHandler<Ast::Scope>>(root->getSeeker());
