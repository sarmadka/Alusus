/**
 * @file Core/Grammar/Module.h
 * Contains the header of class Core::Grammar::Module.
 *
...
#ifndef CORE_GRAMMAR_MODULE_H
#define CORE_GRAMMAR_MODULE_H
               ...
               public Binding, public Inheriting, public IdHaving
{
  ...
  TYPE_INFO(Module, _MyBase, "Core.Grammar", "Core", "alusus.org", (
