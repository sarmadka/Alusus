/**
 * @file Core/Grammar/LexerModule.h
 * Contains the header of class Core::Grammar::LexerModule.
 *
...
#ifndef CORE_GRAMMAR_LEXERMODULE_H
#define CORE_GRAMMAR_LEXERMODULE_H
...
class LexerModule : public Module, public CacheHaving
{
  ...
  TYPE_INFO(LexerModule, Module, "Core.Grammar", "Core", "alusus.org", (
