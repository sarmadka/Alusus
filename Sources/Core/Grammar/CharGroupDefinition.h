/**
 * @file Core/Grammar/CharGroupDefinition.h
 * Contains the header of class Core::Grammar::CharGroupDefinition.
 *
...
#ifndef CORE_GRAMMAR_CHARGROUPDEFINITION_H
#define CORE_GRAMMAR_CHARGROUPDEFINITION_H
...
class CharGroupDefinition : public Node, public Binding, public IdHaving
{
  ...
  TYPE_INFO(CharGroupDefinition, Node, "Core.Grammar", "Core", "alusus.org");
