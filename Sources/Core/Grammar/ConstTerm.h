/**
 * @file Core/Grammar/ConstTerm.h
 * Contains the header of class Core::Grammar::ConstTerm.
 *
...
#ifndef CORE_GRAMMAR_CONSTTERM_H
#define CORE_GRAMMAR_CONSTTERM_H
...
class ConstTerm : public Term
{
  ...
  TYPE_INFO(ConstTerm, Term, "Core.Grammar", "Core", "alusus.org");
