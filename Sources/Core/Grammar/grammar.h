/**
 * @file Core/Grammar/grammar.h
 * Contains the definitions and include statements of all types in the Core::Grammar
 * namespace.
 *
...
#ifndef CORE_GRAMMAR_GRAMMAR_H
#define CORE_GRAMMAR_GRAMMAR_H
...
#define PARSE_REF(qualifier) Core::Grammar::createReference(qualifier)
