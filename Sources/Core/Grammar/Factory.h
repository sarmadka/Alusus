/**
 * @file Core/Grammar/Factory.h
 * Contains the header of class Core::Grammar::Factory.
 *
...
#ifndef CORE_GRAMMAR_FACTORY_H
#define CORE_GRAMMAR_FACTORY_H
...
class Factory
{
  ...
  protected: void setRoot(Module *grammarRoot);
