/**
 * @file Core/Grammar/Term.h
 * Contains the header of class Core::Grammar::Term.
 *
...
#ifndef CORE_GRAMMAR_TERM_H
#define CORE_GRAMMAR_TERM_H
...
class Term : public Node, public Binding
{
  ...
  TYPE_INFO(Term, Node, "Core.Grammar", "Core", "alusus.org", (
