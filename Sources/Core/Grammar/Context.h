/**
 * @file Core/Grammar/Context.h
 * Contains the header of class Core::Grammar::Context.
 *
...
#ifndef CORE_GRAMMAR_CONTEXT_H
#define CORE_GRAMMAR_CONTEXT_H
...
class Context : public TiObject, public MapContaining<TiObject>
{
  ...
  TYPE_INFO(Context, TiObject, "Core.Grammar", "Core", "alusus.org", (
