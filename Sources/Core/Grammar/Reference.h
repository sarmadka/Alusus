/**
 * @file Core/Grammar/Reference.h
 * Contains the header of class Core::Grammar::Reference.
 *
...
#ifndef CORE_GRAMMAR_REFERENCE_H
#define CORE_GRAMMAR_REFERENCE_H
...
class Reference : public Node, public Binding, public CacheHaving
{
  ...
  TYPE_INFO(Reference, Node, "Core.Grammar", "Core", "alusus.org", (
