/**
 * @file Core/Grammar/RandomCharGroupUnit.h
 * Contains the header of class Core::Grammar::RandomCharGroupUnit.
 *
...
#ifndef CORE_GRAMMAR_RANDOMCHARGROUPUNIT_H
#define CORE_GRAMMAR_RANDOMCHARGROUPUNIT_H
...
class RandomCharGroupUnit : public CharGroupUnit
{
  ...
  TYPE_INFO(RandomCharGroupUnit, CharGroupUnit, "Core.Grammar", "Core", "alusus.org");
