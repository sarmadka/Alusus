/**
 * @file Core/Grammar/ReferenceTerm.h
 * Contains the header of class Core::Grammar::ReferenceTerm.
 *
...
#ifndef CORE_GRAMMAR_REFERENCETERM_H
#define CORE_GRAMMAR_REFERENCETERM_H
...
class ReferenceTerm : public Term
{
  ...
  TYPE_INFO(ReferenceTerm, Term, "Core.Grammar", "Core", "alusus.org");
