/**
 * @file Core/Grammar/ConcatTerm.h
 * Contains the header of class Core::Grammar::ConcatTerm.
 *
...
#ifndef CORE_GRAMMAR_CONCATTERM_H
#define CORE_GRAMMAR_CONCATTERM_H
...
class ConcatTerm : public ListTerm
{
  ...
  TYPE_INFO(ConcatTerm, ListTerm, "Core.Grammar", "Core", "alusus.org");
