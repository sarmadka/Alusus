/**
 * @file Core/Grammar/ParsingDimension.h
 * Contains the header of class Core::Grammar::ParsingDimension.
 *
...
#ifndef CORE_GRAMMAR_PARSINGDIMENSION_H
#define CORE_GRAMMAR_PARSINGDIMENSION_H
...
class ParsingDimension : public Node, public Binding
{
  ...
  TYPE_INFO(ParsingDimension, Node, "Core.Grammar", "Core", "alusus.org", (
