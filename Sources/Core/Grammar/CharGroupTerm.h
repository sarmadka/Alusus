/**
 * @file Core/Grammar/CharGroupTerm.h
 * Contains the header of class Core::Grammar::CharGroupTerm.
 *
...
#ifndef CORE_GRAMMAR_CHARGROUPTERM_H
#define CORE_GRAMMAR_CHARGROUPTERM_H
...
class CharGroupTerm : public Term
{
  ...
  TYPE_INFO(CharGroupTerm, Term, "Core.Grammar", "Core", "alusus.org");
