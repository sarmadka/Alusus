/**
 * @file Core/Grammar/ListTerm.h
 * Contains the header of class Core::Grammar::ListTerm.
 *
...
#ifndef CORE_GRAMMAR_LISTTERM_H
#define CORE_GRAMMAR_LISTTERM_H
...
class ListTerm : public Term, public MapContaining<TiObject>
{
  ...
  TYPE_INFO(ListTerm, Term, "Core.Grammar", "Core", "alusus.org", (
