/**
 * @file Core/Grammar/MultiplyTerm.h
 * Contains the header of class Core::Grammar::MultiplyTerm.
 *
...
#ifndef CORE_GRAMMAR_MULTIPLYTERM_H
#define CORE_GRAMMAR_MULTIPLYTERM_H
...
class MultiplyTerm : public Term, public CacheHaving, public MapContaining<TiObject>
{
  ...
  TYPE_INFO(MultiplyTerm, Term, "Core.Grammar", "Core", "alusus.org", (
