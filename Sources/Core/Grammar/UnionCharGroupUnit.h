/**
 * @file Core/Grammar/UnionCharGroupUnit.h
 * Contains the header of class Core::Grammar::UnionCharGroupUnit.
 *
...
#ifndef CORE_GRAMMAR_UNIONCHARGROUPUNIT_H
#define CORE_GRAMMAR_UNIONCHARGROUPUNIT_H
...
class UnionCharGroupUnit : public CharGroupUnit
{
  ...
  TYPE_INFO(UnionCharGroupUnit, CharGroupUnit, "Core.Grammar", "Core", "alusus.org");
