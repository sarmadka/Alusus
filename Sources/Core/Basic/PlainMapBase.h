...
#ifndef CORE_BASIC_PLAINMAPBASE_H
#define CORE_BASIC_PLAINMAPBASE_H

namespace Core::Basic
{

template<class CTYPE, class PTYPE> class PlainMapBase : public PTYPE, public DynamicMapContaining<CTYPE>
{
  //============================================================================
  // Type Info

  TEMPLATE_TYPE_INFO(PlainMapBase, PTYPE, "Core.Basic", "Core", "alusus.org", (CTYPE, PTYPE), (
  ...
  protected: PlainMapBase<CTYPE, PTYPE> *base;
  ...
  public: Signal<void, PlainMapBase<CTYPE, PTYPE>*> destroyNotifier;
  public: Signal<void, PlainMapBase<CTYPE, PTYPE>*, ContentChangeOp, Int> changeNotifier;

  private: Slot<void, PlainMapBase<CTYPE, PTYPE>*> baseDestroySlot = {
    this, &PlainMapBase<CTYPE, PTYPE>::onBaseDestroyed
  };
  private: Slot<void, PlainMapBase<CTYPE, PTYPE>*, ContentChangeOp, Int> baseChangeSlot = {
    this, &PlainMapBase<CTYPE, PTYPE>::onBaseContentChanged
  };
   ...
   * binary search.
   */
  protected: PlainMapBase(Bool useIndex = false) : map(useIndex), inherited(0), base(0)
  {
  }

  /// Delete the index created in the constructor, if any.
  public: virtual ~PlainMapBase() = 0;
  ...
  protected: virtual CTYPE* prepareForSet(Char const *key, Int index, CTYPE *obj, Bool inherited, Bool newEntry) = 0;

  protected: virtual void finalizeSet(Char const *key, Int index, CTYPE *obj, Bool inherited, Bool newEntry) = 0;

  protected: virtual void prepareForUnset(Char const *key, Int index, CTYPE *obj, Bool inherited) = 0;
  ...
  public: PlainMapBase<CTYPE, PTYPE>* getBase() const
  {
    return this->base;
  }
  ...
  private: void attachToBase(PlainMapBase<CTYPE, PTYPE> *b)
  {
    ASSERT(this->base == 0);
  ...
  private: void onBaseContentChanged(PlainMapBase<CTYPE, PTYPE> *obj, ContentChangeOp op, Int index)
  {
  ...
  private: void onBaseDestroyed(PlainMapBase<CTYPE, PTYPE> *obj)
  {
    this->detachFromBase();
  }
...
template<class CTYPE, class PTYPE> PlainMapBase<CTYPE, PTYPE>::~PlainMapBase()
{
}
