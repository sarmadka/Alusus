/**
 * @file Core/Ast/Scope.h
 * Contains the header of class Core::Ast::Scope.
 *
...
#ifndef CORE_AST_SCOPE_H
#define CORE_AST_SCOPE_H
...
class Scope : public List
{
  ...
  TYPE_INFO(Scope, List, "Core.Ast", "Core", "alusus.org");
