/**
 * @file Core/Ast/Token.h
 * Contains the header of class Core::Ast::Token.
 *
...
#ifndef CORE_AST_TOKEN_H
#define CORE_AST_TOKEN_H
...
class Token : public Node, public Binding, public MetaHaving, public Printable
{
  ...
  public: void setText(Char const *t, Word s)
  {
    this->text.set(t, s);
  }
  ...
  public: void setText(WChar const *t, Word s)
  {
    this->text.set(t, s);
  }
  ...
  {
    stream << S("Token: ");
    stream << ID_GENERATOR->getDesc(this->getId());
