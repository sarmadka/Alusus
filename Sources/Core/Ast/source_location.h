/**
 * @file Core/Ast/SourceLocationRecord.h
 * Contains the header of class Core::Ast::SourceLocationRecord.
 *
...
#ifndef CORE_AST_SOURCELOCATION_H
#define CORE_AST_SOURCELOCATION_H
...
{
  TYPE_INFO(SourceLocation, TiObject, "Core.Ast", "Core", "alusus.org");
};
...
class SourceLocationRecord : public SourceLocation
{
  ...
  TYPE_INFO(SourceLocationRecord, SourceLocation, "Core.Ast", "Core", "alusus.org");
...
class SourceLocationStack : public SharedListBase<SourceLocation, SourceLocation>
{
  ...
  TYPE_INFO(SourceLocationStack, _MyBase, "Core.Ast", "Core", "alusus.org");
