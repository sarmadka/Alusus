...
SharedPtr<Ast::Node> Engine::processFile(Char const *filename)
{
  // Open the file.
...
SharedPtr<Ast::Node> Engine::processStream(CharInStreaming *is, Char const *streamName)
{
  // Open the file.
  if (is == 0) {
