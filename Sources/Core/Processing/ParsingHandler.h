 ...
 */
class ParsingHandler : public Grammar::BuildHandler
{
  //============================================================================
  // Type Info

  TYPE_INFO(ParsingHandler, Grammar::BuildHandler, "Core.Parser", "Core", "alusus.org");
   ...
   */
  public: virtual void onTermStart(Parser *parser, ParserState *state, Ast::Token const *token)
  {
  }
   ...
   */
  public: virtual void onNewToken(Parser *parser, ParserState *state, Ast::Token const *token)
  {
  }
   ...
   */
  public: virtual Bool onErrorToken(Parser *parser, ParserState *state, Ast::Token const *token)
  {
    return false;
  }
   ...
   */
  public: virtual void onAlternateRouteDecision(Parser *parser, ParserState *state, Int route, Ast::Token const *token)
  {
  }
   ...
   */
  public: virtual void onMultiplyRouteDecision(Parser *parser, ParserState *state, Int route, Ast::Token const *token)
  {
  }
   ...
   */
  public: virtual void onConcatStep(Parser *parser, ParserState *state, Int newPos, Ast::Token const *token)
  {
  }
