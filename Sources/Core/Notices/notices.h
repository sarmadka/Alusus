...
/**
 * @brief Get a string representation of a source location.
 * @ingroup core_notices
 */
Str getSourceLocationString(Ast::SourceLocation *sl, Int indentation = 0);

void setSourceLocationPathSkipping(Bool skip);
